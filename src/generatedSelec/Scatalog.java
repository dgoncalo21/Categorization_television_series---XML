...
@XmlType(name = "", propOrder = { "serie" })
@XmlRootElement(name = "scatalog")
public class Scatalog
{
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Serie }
	 * 
	 * 
	 */
	...
	public void setSerie(List<Serie> novaSerie)
	{
		if (serie == null)
		{
			serie = novaSerie;
